                ...
                <div className="customStyle mb-10">
                        ...
                        shopifyProduct.variants[0].quantityAvailable > 0 ? (
                            <>
                                <FormattedNumber
                                    ...
                                    currency={
                                        shopifyProduct.variants[0].priceV2.currencyCode
                                    }
                    ...
                    <div className="text-xs my-5 mb-10">
                        ...
                        <div className="available-store-container">
                            <div className="containerStoresPDP">
                                <img className="available-store-img" src={stores[1].image.src}
                    ...
                    <div className="flex flex-col mb-2">
                        <div
                            ...
                            onClick={() => setAccordion({...accordion, size: !accordion.size})}
                        >
