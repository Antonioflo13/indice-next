    ...
    <>
      <div className="w-full flex flex-col items-start md:items-end md:text-right">
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div onClick={() => {setShown(true); setSelectSingleIcon(whatappIcon)}}><Label><FormattedMessage id="whatsapp" /></Label></div>
          <Label onClick={() => setContactShown(true)}><FormattedMessage id="contact_us" /></Label>
        </div>
      </div>
      {show && (
